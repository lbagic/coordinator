...
- `prompt <name> --kind K [--effort E] [--gate] [--runner] [--force] [--from FILE | --ask … --done … …]`; `--from` reads `Label:` lines or `## Label` headings, and a file holding neither is refused by its first line
